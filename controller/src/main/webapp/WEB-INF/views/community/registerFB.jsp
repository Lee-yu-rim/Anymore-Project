...
<section class="ftco-section" style="font-family: 'NanumSquareNeo';">
   ...
   <div class="container">
      ...
      <form role="form" id="form" action="/community/registerFB" method="post" style="color:black">
         ...
         <button id="listBtn" type="button" class="btn btn-primary" onclick="location.href='/community/freeBoard'">목록</button>
      </form>
   </div>
</section>
