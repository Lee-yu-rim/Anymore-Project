...
<!-- 	                <input type="checkbox" id="keep_id" class="keep_id" value="off"> -->
<!-- 	                <label for="keep_id" class="keep_text">자동 로그인</label> -->
<!-- 	            </div> -->
...
<!-- 			<form class="login_form_admin" id="login_staff" name="login_staff" action="/login_staff" method="post"> -->
<!-- 				<ul> -->
...
<!-- 	                <input type="checkbox" id="staff" class="staff" value="on" checked> -->
<!-- 	                <label for="staff" class="staff_chk">관리자로 로그인</label> -->
<!-- 	            </div> -->
	            
<!-- 	            <div class="login_button"> -->
<!-- 	            	<input type="submit" id="login_btn" class="login_btn btn-default" value="로그인"> -->
<!-- 	            </div> -->
