...
<section class="ftco-section" style="font-family: 'NanumSquareNeo';">
	...
	<div class="container">
		...
		<form role="form" action="/community/modifyUI" method="post" style="color:black">
			...
			<div class="form-group">
				<label>제목</label> 
				<input class="form-control" name="title" value='<c:out value="${usedItems.title}" />'>
			</div>
			
			<div class="form-group">
				<label>내용</label>
				<textarea class="form-control" name="content" rows="14""><c:out value="${usedItems.content}" /></textarea>
			</div>
