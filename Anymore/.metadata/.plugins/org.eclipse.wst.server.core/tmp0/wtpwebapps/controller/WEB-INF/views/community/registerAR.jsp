...
<section class="ftco-section" style="font-family: 'NanumSquareNeo';">
   ...
   <div class="container">
      ...
      <form role="form" action="/community/registerAR" method="post" style="color:black">
         ...
         <button id="listBtn" type="button" class="btn btn-outline-dark" onclick="location.href='/community/adoptionReview'">목록</button>
      </form>
   </div>
</section>
