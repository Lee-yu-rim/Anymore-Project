...
<section>
    ...
    <section class="cart">
        ...
        <table class="cart__list">
            <form>
                <tbody>
                    ...
                    <tr class="cart__list__detail">
                        <td>주소: 서울시 강서구 방학동 11-00 번지 5층</td>
                    </tr>
                    <tr class="cart__list__detail">
                        <td>연락처: 010-1537-4887</td>
                    </tr>
                    <tr class="cart__list__detail">
                        <td>배송요청사항: 부재시 경비실에 맡겨 주세요</td>
                    </tr>
                </tbody>
            </form>
        </table>
        ...
        <div class="cart__mainbtns">
            ...
            <a href="current_perchase_modify"><button class="cart__bigorderbtn right">수정</button></a>
        </div>
    </section>
</body>
