    ...
    <div class="container">
      <div class="row justify-content-center" >
            <table class="table">
                <tr>
                    <th>상품이름</th>
                    <td><textarea cols="30" rows="1">훈련용 양고기 육포</textarea></td>
                </tr>
                <tr>
                    <th>가격</th>
                    <td><textarea cols="10" rows="1">15000</textarea></td>
                </tr>
                <tr>
                    <th>수량</th>
                    <td><textarea cols="10" rows="1">52000</textarea></td>
                </tr>
                <tr>
                    <th>상품설명</th>
                    <td>
                        <form>
                            <p><textarea cols="100" rows="10">이 상품은 정말 끝내줍니다. 사람이 먹어도 맛이 있어요!</textarea></p>
                        </form>
                    </td>
                </tr>
                <tr>
            ...
            <button type="button" class="btn btn-primary" style="float: right;"><a href="product_manage">수정등록</a></button>
    </div>	<!-- end container -->
  </section>
