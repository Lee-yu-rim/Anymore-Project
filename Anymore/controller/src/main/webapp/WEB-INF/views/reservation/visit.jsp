	...
	<div class="container" style="font-family: 'NanumSquareNeo';">
		<div class="row no-gutters slider-text align-items-end">
			<div class="col-md-9 ftco-animate pb-5">
				<h1 class="mb-0 bread" style="font-family: 'NanumSquareNeo';">방문상담 예약</h1>
 		...
 		<div class="row d-md-flex justify-content-center">
 			<div class="col-md-12 col-lg-6 ftco-animate rounded" 
 				...
 				<form role="form" id="form" action="/reservation/visit" class="appointment" method="post">
 					...
 					<input type='hidden' name='visit_identify' value='1'>
 					<div class="row">
						<div class="col-md-12">
						...
						<div class="col-md-12">
							<div class="form-group rounded">
	              				<textarea cols="30" rows="7" class="form-control" id="visit_reason" id="visit_reason" name="visit_reason" placeholder="내용" ></textarea>
	            			</div>
						</div>
						<div class="col-md-12">
							<div class="form-group rounded">
