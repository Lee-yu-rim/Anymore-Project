...
<section class="ftco-section bg-light">
	<div class="container join_terms">
					...
					<div class="row mb-5">
						<div class="col-md-4">
							<div class="dbox w-100 text-center">
		        				...
		        				<div class="text">
			            			<p><span>약관 동의</span></p><hr style="border: solid 1px #AD8B73;">
			          			</div>
		          			</div>
						</div>
						<div class="col-md-4">
					...
					<div class="row no-gutters terms_content">
						<div class="col-md-12">
							<div class="contact-wrap w-100 p-md-5 p-4">
								<h3 class="mb-4">약관 동의</h3>
								<form method="POST" action="/join/join_form" id="terms" name="terms" class="terms">
									<div class="row">
										<div class="col-md-12">
											<div class="form-group">
												<input type="checkbox" id="terms_1_check" name="terms_1_check">
												<label class="label" for="terms_1">개인정보 수집 및 이용 동의</label>
												<textarea name="terms_1" class="form-control" id="terms_1" cols="30" rows="10" readonly>
1. 개인정보의 수집항목 및 수집방법 
  ...
  * 수탁업체
    ...
    - 행정자치부
      ...
      · 개인정보 보유 및 이용 기간 : 행정자치부에서는 이미 보유하고 있는 개인정보이기 때문에 별도로 저장하지 않음
										...
										<div class="col-md-12">
											<div class="form-group">
												<input type="checkbox" id="terms_2_check" name="terms_2_check">
												<label class="label" for="terms_2">서비스 약관 동의</label>
												<textarea name="terms_2" class="form-control" id="terms_2" cols="30" rows="10" readonly>
제 1 장 총칙
...
(시행일) 본 약관은 2018년 8월 1일부터 시행됩니다. 개정된 약관의 적용일자 이전 이용자 또는 회원은 개정된 이용약관의 적용을 받습니다.
										...
										<div class="col-md-12">
											<div class="form-group">
												<a href="/index"><input type="button" value="취소" class="btn btn-primary"></a>
												<input type="submit" value="다음" class="btn btn-primary" onclick="return validation()">
											</div>
										</div>
									</div>
								</form>
...
<script>
	...
	function validation(){
		...
		var checkbox = document.getElementById("terms_1_check");
		var checkbox2 = document.getElementById("terms_2_check");
		
		if(!checkbox.checked){
			$(".modal-body").html("약관에 동의해주세요.");
