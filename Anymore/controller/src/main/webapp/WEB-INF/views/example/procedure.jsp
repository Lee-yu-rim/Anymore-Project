      ...
      <div class="container" style="font-family: 'NanumSquareNeo';">
        <div class="row no-gutters slider-text align-items-end">
          <div class="col-md-9 ftco-animate pb-5">
            ...
            <h1 class="mb-0 bread" style="font-family: 'NanumSquareNeo';">입양절차</h1>
            <br>
	...
	<div class="container">
		<div class="row justify-content-center pb-5 mb-3">
			<div class="col-md-7 heading-section text-center ftco-animate">
				<span><img src="../images/animal-care.png"></span>
				<h2>입양절차</h2>
			</div>
		</div>
		<br>
		...
		<div class="row mb-5 pb-5">
			...
			<div class="row" style="margin-top: 80px; padding-top: 80px">
				<div class="col-md-6 d-flex align-self-stretch px-4 ftco-animate">
					<div class="d-block services text-center">
						<div class="icon d-flex align-items-center justify-content-center">
