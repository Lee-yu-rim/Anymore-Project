			...
			<div class="panel panel-default">
				...
				<div class="panel-body">
					<div class = "form-group">
						<label>회원번호</label>
						<input class="form-control" name='bno' value='<c:out value = "${member.member_num }"/>' readonly="readonly">
					</div>
					<div class = "form-group">
						<label>아이디</label>
						<input class="form-control" name='title' value='<c:out value = "${member.id }"/>' readonly="readonly">
					</div>
					<div class = "form-group">
						<label>이름</label>
						<textarea class="form-control" rows="3" name='content' readonly="readonly"><c:out value = "${member.name }" /> </textarea>
					</div>
					<div class = "form-group">
						<label>가입일</label>
						<input class="form-control" name='writer' value='<c:out value = "${member.regdate }"/>' readonly="readonly">
					</div>
					<div class = "form-group">
						<label>등급</label>
						<input class="form-control" name='writer' value='<c:out value = "${member.writer }"/>' readonly="readonly">
					</div>
					<div class = "form-group">
						<label>전화번호</label>
						<input class="form-control" name='writer' value='<c:out value = "${member.phone }"/>' readonly="readonly">
					</div>
					<div class = "form-group">
						<label>비밀번호</label>
						<input class="form-control" name='writer' value='<c:out value = "${member.password }"/>' readonly="readonly">
					</div>
					<div class = "form-group">
						<label>신고수</label>
						<input class="form-control" name='writer' value='<c:out value = "${member.alert_cnt }"/>' readonly="readonly">
					</div>
